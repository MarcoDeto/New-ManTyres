...
export class InventarioService {
  ...
  getInventarioByTarga(skip: number, take: number, sede: number, stagione: number, orderByDesc: boolean | null, targa: string): Observable<Response> {
    let Targa = '&targa=' + targa;
    if (targa == null) { Targa = ''; }
    // TO DO
    let orderByDescLink = '&inizioOrderByDesc=' + orderByDesc;
    orderByDescLink = '';

    return this.http.get<Response>(environment.inventario + '/GetInventarioByTarga?skip=' + skip + '&take=' + take + '&sede=' + sede + '&stagione=' + stagione + orderByDescLink + Targa);
  }

  getArchivio(skip: number, take: number, sede: number, stagione: number, inizioOrderByDesc: boolean | null, fineOrderByDesc: boolean | null): Observable<Response> {
  ...
  GetArchivioByTarga(skip: number, take: number, sede: number, stagione: number, inizioOrderByDesc: boolean | null, fineOrderByDesc: boolean | null, targa: string): Observable<Response> {
    let inizioOrderByDescLink = '&inizioOrderByDesc=' + inizioOrderByDesc;
    let fineOrderByDescLink = '&fineOrderByDesc=' + fineOrderByDesc;
    let Targa = '&targa=' + targa;
    if (targa == null) { Targa = ''; }
  ...
  getCestino(skip: number, take: number, sede: number, stagione: number, inizioOrderByDesc: boolean | null, fineOrderByDesc: boolean | null): Observable<Response> {
    let inizioOrderByDescLink = '&inizioOrderByDesc=' + inizioOrderByDesc;
    let fineOrderByDescLink = '&fineOrderByDesc=' + fineOrderByDesc;
    if (inizioOrderByDesc == null) { inizioOrderByDescLink = ''; }
    if (fineOrderByDesc == null) { fineOrderByDescLink = ''; }
  ...
  getCestinoByTarga(skip: number, take: number, sede: number, stagione: number, inizioOrderByDesc: boolean | null, fineOrderByDesc: boolean | null, targa: string): Observable<Response> {
    let inizioOrderByDescLink = '&inizioOrderByDesc=' + inizioOrderByDesc;
    let fineOrderByDescLink = '&fineOrderByDesc=' + fineOrderByDesc;
    let Targa = '&targa=' + targa;
    if (targa == null) { Targa = ''; }
